...
<td bgcolor="#FFFFFF">
    <?php echo $this->element('error_message'); ?>
            ユーザーID（メールアドレス）を入力し「OK」ボタンをクリックして下さい。メールでパスワードが届きます。 <br><br>
	<form action="/remain/process" method="post">
	ユーザーID：&nbsp;<input type="text" name="id" value="<?php if(isset($returnData)) echo $returnData['id']; ?>"><br><br>
	生年月日：&nbsp;&nbsp;&nbsp;<select name="birthyear"><?php echo $birthyear; ?></select><br><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<select name="month"><?php echo $month; ?></select>月 <select name="date"><?php echo $date; ?></select>日 <br>
